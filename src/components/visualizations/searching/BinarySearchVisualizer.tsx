...
/**
 * SearchStep - Đại diện cho một bước trong quá trình tìm kiếm.
 */
interface SearchStep {
    /**
     * array: Mảng hiện tại (không thay đổi trong Binary Search).
     */
    array: number[];

    /**
     * left: Index của left pointer.
     */
    left: number;

    /**
     * right: Index của right pointer.
     */
    right: number;

    /**
     * mid: Index của middle element đang xét.
     * -1 nếu không có (trước khi bắt đầu hoặc sau khi kết thúc).
     */
    mid: number;
    ...
    /**
     * foundIndex: Index nơi tìm thấy target.
     * -1 nếu chưa tìm thấy hoặc không tồn tại.
     */
    foundIndex: number;

    /**
     * eliminated: Indices đã bị loại khỏi search space.
     */
    eliminated: number[];
...
export type { BinarySearchVisualizerProps, SearchStep };
