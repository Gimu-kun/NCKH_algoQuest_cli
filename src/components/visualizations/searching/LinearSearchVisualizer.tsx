...
import type { LinearSearchStep } from '../types';
import { generateLinearSearchSteps } from '../../../algo_demos/Chapter_2_Search_Sort/LinearSearch';
...
export type { LinearSearchVisualizerProps };
